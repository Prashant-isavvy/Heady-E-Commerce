...
extension UIAlertController {
    ...
    public func show(animated: Bool = true, vibrate: Bool = false, completion: (() -> Void)? = nil) {
        ...
        UIApplication.shared.keyWindow?.topMostWindowController()?.present(self, animated: animated, completion: completion) //UIApplication.shared.keyWindow?.rootViewController?.present(self, animated: animated, completion: completion)
        if vibrate {
